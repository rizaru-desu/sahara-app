...
import { activeUser, inActiveCampaign } from "@/app/utils/db/controllerDB";
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (tokenValidated) {
      const result = await inActiveCampaign({
        campaignId: resultValid.campaignId,
      ...
      return NextResponse.json(
        {
          message: `The ${result.campaignName} has  ${
            result.inActive ? "not" : ""
          } been active.`,
        },
        {
