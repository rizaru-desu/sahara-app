...
import { labelBoxProductPagination } from "@/app/utils/db/controllerDB";
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (tokenValidated) {
      const { result, count } = await labelBoxProductPagination({
      ...
      return NextResponse.json(
        {
          allLabelProduct: finalResult,
          countLabelProduct: count,
        },
        {
          status: 200,
        }
