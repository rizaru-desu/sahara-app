...
import { forgotPasswordUser } from "@/app/utils/db/controllerDB";
import z from "zod";
...
export async function POST(request: NextRequest) {
  try {
    ...
    await sendMailer({
      ...
      subject: `${result?.fullname}, Your Password Recovery Request`,
      html: html({
        email: result?.email,
