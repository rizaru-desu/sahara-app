...
import { stockProdutRangeSearch } from "@/app/utils/db/controllerDB";
import _ from "lodash";
import z from "zod";

const Schema = z
  .object({
    rangeDate: z.object({ startDate: z.string(), endDate: z.string() }),
  })
  .strict();
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (tokenValidated) {
      const result = await stockProdutRangeSearch({
        rangeDate: resultValid.rangeDate,
      });
